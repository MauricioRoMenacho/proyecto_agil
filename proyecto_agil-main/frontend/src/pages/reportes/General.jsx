...
const resumenMock = { totalAssets: 0, criticalAssets: 0, totalUnits: 0, inUseAssets: 0 };

const COLORS = ['#10b981', '#f59e0b', '#3b82f6', '#ef4444']; // colores para el gráfico de estado

const General = () => {
  const [summary, setSummary] = useState(resumenMock);
  ...
  useEffect(() => {
    getEstadisticas()
      .then(res => {
        setSummary(res.summary || resumenMock);
